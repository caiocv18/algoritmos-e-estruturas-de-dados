...
# Importação relativa e absoluta# Em um projeto estruturado:# projeto/#   ├── main.py#   ├── utils/#   │   ├── __init__.py#   │   ├── math_utils.py#   │   └── string_utils.py#   └── models/#       ├── __init__.py#       └── user.py# No arquivo main.py:# from utils.math_utils import calcular_media# from models.user import Usuario# Dentro de utils/math_utils.py (importação relativa):# from .string_utils import limpar_espacos